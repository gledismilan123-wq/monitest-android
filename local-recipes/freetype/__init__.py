"""
Copia della recipe "freetype" di python-for-android, con l'UNICA differenza
che il file sorgente si scarica da un mirror SourceForge invece che da
download.savannah.gnu.org - che al momento risulta irraggiungibile dai
runner di GitHub Actions (errori HTTP 502/504 ripetuti) e blocca la build.
Stesso identico file .tar.gz, solo un altro host da cui prenderlo.
"""
